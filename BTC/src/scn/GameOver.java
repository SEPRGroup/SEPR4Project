...
public class GameOver extends Scene {
	...
	public void start() {
		...
		text_box.delay(0.4);
		text_box.addText("British Bearways is facing heavy legal pressure from the family and loved-ones of the dead and an investigation is underway.");
		text_box.newline();
		text_box.delay(0.8);
		text_box.addText("The inquiry into your incompetence will lead to humanity discovering your true nature.");
		text_box.newline();
		text_box.delay(0.8);
		text_box.addText("The guilt for the death you have caused and your failure to pass as a human will gnaw at you and you will revert to drinking in an attempt to cope.");
		text_box.newlines(2);
		text_box.delay(0.8);
		text_box.addText("With no income, there will be no way your family can survive the fast-approaching winter months.");
		text_box.newlines(2);
		text_box.delay(0.8);
